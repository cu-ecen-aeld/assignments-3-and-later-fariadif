...
void *threadfunc(void *thread_param)
{
    ...
    if (usleep((unsigned int)thread_func_args->wait_to_obtain_ms * 1000))
    {
    ...
    if (usleep((unsigned int)thread_func_args->wait_to_release_ms * 1000))
    {
        thread_func_args->thread_complete_success = false;
